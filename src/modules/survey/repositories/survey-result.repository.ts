...
export class SurveyResultRepository {
  ...
  async create(surveyResult: PartialSurveyResultOmit): Promise<ISurveyResult> {
    return await this.model.create(surveyResult);
  }

  async findBySurveyId(surveyId: SurveyKey): Promise<ISurveyResult> {
  ...
  async delete(surveyId: SurveyKey): Promise<void> {
